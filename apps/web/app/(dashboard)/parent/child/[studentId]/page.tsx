...
import {
  ArrowLeft, TrendingUp, Award, BookOpen, FileText,
} from 'lucide-react';
import { gradeApi, academicYearApi } from '@/lib/academic-api';
...
export default function ParentChildPage() {
  ...
  useEffect(() => {
    academicYearApi.getCurrent().then((res) => setAcademicYear(res.data.data));
  }, []);
